        ...
        <table>
            <thead>
                <tr>
                    ...
                    <td class="xs-hide"><p>Time used</p></td>
                    <td></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="td-overflow"><a title="" href='/project/view/104'>123</a></td>
                    <td>19/09/2022</td>
                    <td class="xs-hide">00:00</td>
                    <td>
                        <div class="action-links">
                            <!-- <a href="/project/edit/104" title="Edit project"><i class="fa-solid fa-edit"></i></a> -->
                            <!-- <a href="/task/add/104" title="Add new task to project"><i class="fa-solid fa-plus"></i></a> -->
                            <a href="/add_time" title="Add new task to project"><i class="fa-solid fa-plus"></i></a>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="td-overflow"><a title="123" href='/project/view/102'>123</a></td>
                    <td>17/09/2022</td>
