                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        <li class="active open">
                            <a href="#" title="Projects" data-filter-tags="Projects">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">Navigete</span>
                            </a>
                            <ul>
                                <li class="home">
                                    <a href="/" title="page_home" data-filter-tags="apage_home">
                                        <span class="nav-link-text" data-i18n="nav.application_intel_analytics_dashboard">Home</span>
                                    </a>
                                </li>
                                <li class="time_traker">
                                    <a href="/time_traker" title="page_time_traker" data-filter-tags="apage_time_traker">
                                        <span class="nav-link-text" data-i18n="nav.application_intel_analytics_dashboard">Time Traker</span>
                                    </a>
                                </li>
                ...
                <header class="page-header" role="banner">
                    ...
                    <div>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <x-dropdown-link class="btn btn-light" :href="route('logout')" onclick="event.preventDefault();
